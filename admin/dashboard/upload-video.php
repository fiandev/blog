  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse navbar-collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="<?= base_url(); ?>admin/dashboard/upload-video.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <form action="" method="post" enctype="multipart/form-data" class="form-control">
          ...
          <input required  class="form-control" type="file" accept="video/*" name="thumbnail" id="thumbnail" value="" />
