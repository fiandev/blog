...
require "../../config.php";$res = mysqli_query($conn, "SELECT * FROM article WHERE title='black hole buatan'");$rows = mysqli_fetch_assoc($res);if(isset($_GET)){$id = $rows["id"];$visit = $rows["visited"];$visit = $visit + 1;mysqli_query($conn, "UPDATE article SET visited=$visit WHERE id=$id ");}
?>
<!DOCTYPE html>
<html>
<head>
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale°1"><title>black hole buatan</title>
